...
<div class="flex gap-2 flex-wrap">
    ...
    <div class="w-full h-fit space-y-2 md:w-1/2">
        <div class="flex w-full p-4 h-fit  justify-center items-center bg-yellow-400 rounded-md">
            <img class="h-6"
...
<section class="flex flex-col gap-4 w-full py-6">
    ...
    <button onclick="changeContentToCard()"
        class="flex w-full md:w-fit justify-between gap-6 border border-gray-400 items-center rounded-md p-6">
...
<section class="flex flex-col gap-4 py-6">
    ...
    <div class="flex gap-6 items-center p-6 border border-gray-500 rounded-md w-full lg:w-1/2">
        <img class="w-10 h-10"
...
<section class="flex flex-col py-6 gap-4">
    ...
    <div class="flex flex-col lg:flex-row gap-4">
        <button onclick="changeContentToKlarna()"
            class="flex flex-1 border border-gray-400 p-10 gap-6 items-center rounded-md">
        ...
        <button onclick="changeContentToAffirm()"
            class="flex flex-1 border border-gray-500 p-10 gap-6 rounded-md items-center">
